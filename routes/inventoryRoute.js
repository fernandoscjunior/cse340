...
router.get("/", utilities.checkCredentials, 
    utilities.handleErrors(invController.deliverManagement));

// Route to deliver Classification form view
router.get("/classification/", utilities.checkCredentials, 
    utilities.handleErrors(invController.deliverClassification));
...
router.get("/inventory", utilities.checkCredentials, 
    utilities.handleErrors(invController.deliverInventory));
...
//Route to deliver confirmation pre-delete view based on car(inventory) id
router.get("/delete/:inventory_id", utilities.handleErrors(invController.getDeleteView))
